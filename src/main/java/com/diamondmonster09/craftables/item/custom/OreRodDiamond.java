...
public class OreRodDiamond extends Item {
    public OreRodDiamond(Settings settings){
        super(settings);
    }
    ...
    private boolean isMetal(Block block){
        return block == Blocks.DIAMOND_ORE || block == Blocks.EMERALD_ORE || block == Blocks.LAPIS_ORE;
    }
}
